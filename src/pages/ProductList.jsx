...
function ProductList() {
  ...
  const [isEcoFriendly, setIsEcoFriendly] = useState(() => {
    return localStorage.getItem('isEcoFriendly') || 'all';
  });
  const [priceRange, setPriceRange] = useState(() => {
    return localStorage.getItem('priceRange') || 'all';
  });
  // ==================================
  ...
  const handleEcoFriendlyChange = (e) => {
    ...
    const newEcoFriendly = e.target.value;
    setIsEcoFriendly(newEcoFriendly);
    localStorage.setItem('isEcoFriendly', newEcoFriendly);
  };
  ...
  const handlePriceRangeChange = (e) => {
    ...
    localStorage.setItem('priceRange', newPriceRange);
  };
  ...
  return (
    <main>
      <Navbar />
      <div className='flex flex-col items-center justify-center w-full md:pt-10'>
          ...
          {loading ? (
            ...
            currentProducts.map((product) => (
              <div
                ...
                <img
                  src={product.image}
                  className='rounded-md shadow-md h-52 w-52'
                  alt={product.name}
                />
            ...
            <p className='mt-5 ml-5'>No products available for this filter.</p>
          )}
        </div>
        <Pagination
